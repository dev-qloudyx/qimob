...
class ImovelFilter(django_filters.FilterSet):
    ...
    imovel_type = django_filters.ChoiceFilter(field_name='imovel_type__imovel_type', label='Tipo de Imovel', choices=lambda: [[i.imovel_type.imovel_type, i.imovel_type.imovel_type] for i in Imovel.objects.all().distinct('imovel_type__imovel_type')])
